# TikTok Shop US Seller Playbook Skill

English | 中文

An open-source Codex Skill for creating, expanding, auditing, and formatting practical TikTok Shop US seller playbooks.

一个开源 Codex Skill，用来生成、扩写、审校和排版实用的美国 TikTok Shop 开店运营手册。
...
```text
Use $tiktok-shop-us-seller-playbook to create a compliant bilingual TikTok Shop US seller onboarding playbook.
```
