...
## Seller Preparation Table / 开店资料准备表

| Item / 项目 | Owner / 负责人 | File or Link / 文件或入口 | Status / 状态 | Risk Notes / 风险备注 |
|---|---|---|---|---|
| Business documents / 主体资料 |  |  | Not started / 未开始 |  |
| Tax documents / 税务资料 |  |  | Not started / 未开始 |  |
| Bank or payment account / 银行或收款 |  |  | Not started / 未开始 |  |
| Warehouse address / 仓库地址 |  |  | Not started / 未开始 |  |
| Return address / 退货地址 |  |  | Not started / 未开始 |  |
| Customer service email / 客服邮箱 |  |  | Not started / 未开始 |  |
...
|---|---|---|---|
| Morning / 上午 | Check orders, inventory, customer service, refunds / 查订单、库存、客服、退款 |  | □ |
| Afternoon / 下午 | Check content data, creator replies, ad spend / 查内容数据、达人回复、广告花费 |  | □ |
| Evening / 晚上 | Review issues, plan tomorrow's posts and replenishment / 复盘异常、安排明日发布和补货 |  | □ |

## Weekly Review Table / 每周复盘表

| Metric / 指标 | This Week / 本周 | Last Week / 上周 | Change / 变化 | Diagnosis / 判断 | Next Action / 下周动作 |
|---|---:|---:|---:|---|---|
| GMV / 销售额 |  |  |  |  |  |
| Orders / 订单数 |  |  |  |  |  |
| Conversion Rate / 转化率 |  |  |  |  |  |
